          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="map-container">
                <iframe src="./img/H2.png" width="510" height="566" frameBorder="0" allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>
              </div>
              ...
              <tbody>
                {herramientas.map(herramienta => (
                  <tr key={herramienta.CODIGO}>
                    ...
                    <td><button type="button" className="btn btn-success almacen" value={herramienta.HERRAMIENTA}><span className="glyphicon glyphicon-edit"></span>+</button></td>
